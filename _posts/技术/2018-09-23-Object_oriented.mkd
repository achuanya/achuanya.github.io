...
## 五. 类与对象的关系
这个我表达能力不太好哈...这样说吧，类就好比工厂车间的模具，而对象就是模具所产生的事物，一个模具是可以产生很多对象![Alt text](https://raw.githubusercontent.com/achuanya/achuanya.github.io/master/assets/image/1.gif "滑稽")
...
### 2. 对象的创建及使用:   
类名称 对象名称 = null;&emsp;&emsp;&emsp;&emsp;//声明对象  
对象名称 = new 类名([参数列表]);&emsp;&emsp;&emsp;&emsp;//实例化对象  
* 对象中成员的访问:
$引用名 = new 类名(构造参数);&emsp;&emsp;&emsp;&emsp;//对象属性赋值  
$引用名 -> 成员属性 = 赋值;&emsp;&emsp;&emsp;&emsp;//输出对象的属性  
$引用名 -> 成员方法(参数);&emsp;&emsp;&emsp;&emsp;//调用对象的方法  
...
呼～ 第一章写完了，我也是近期刚学OOP，可能哪个方面写的并不是很好 嘿嘿，如有写的不足之处，还请您在下方留言![Alt text](https://raw.githubusercontent.com/achuanya/achuanya.github.io/master/assets/image/baoquan.gif "抱拳")。
