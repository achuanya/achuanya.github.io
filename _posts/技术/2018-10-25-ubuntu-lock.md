...
![Alt text]({{ site.article }}2018-10-25-ubuntu-lock/1.png "E: 无法获得锁......(11: 资源暂时不可用")  
...
![Alt text]({{ site.article }}2018-10-25-ubuntu-lock/2.png "删除成功！") 

dpkg 查一下 kchmviewer 是否存在

		$ dpkg -s kchmviewer

![Alt text]({{ site.article }}2018-10-25-ubuntu-lock/3.png "系统没有安装包kchmviewer") 
