...
comments: true
layout: post
title: ionic笔记（环境部署与命令）
description: ionic笔记（环境部署与命令）
category: 技术
---

&emsp;昨天下午项目经理让我学习 ionic，就折腾了一下，因为 ionit 我也喜欢上了 ionic 和 node.js，不过我也是在折腾的道路上越走越远，别看博客上就那么多东西，可小白的我操作起来真的非常难受，中途遇到各种问题哎...<br>
