...
## 移动、重命名与删除文件
        ...
        # 移动与重命名道理是一样的
        $ git mv
![Alt text](https://raw.githubusercontent.com/achuanya/achuanya.github.io/master/assets/image/rename.png "重命名操作")
...
![Alt text](https://raw.githubusercontent.com/achuanya/achuanya.github.io/master/assets/image/gitshuyu.png "Git专业术语中英文对照表")
